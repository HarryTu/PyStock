...
#csc使用范例
data = c.csc("300059.SZ", "OPEN,CLOSE,HIGH", "2016-08-10", "2016-08-11","Ispandas=0")
print u"csc输出结果======分隔线======"
...
#csd使用范例
data = c.csd("300059.SZ,600425.SH", "open,close,high", "2016-07-01", "2016-07-06", "RowIndex=1,period=1,adjustflag=1,curtype=1,pricetype=1,Ispandas=0")
print u"csd输出结果======分隔线======"
if(not isinstance(data, c.EmQuantData)):
    print data
else:
...
#tradedate使用范例
data = c.tradedates("2016-07-01", "2017-07-12")
if data.ErrorCode != 0:
