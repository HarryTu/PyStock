...
def InsertRTData( stockdata, logger, mytime ):
    ...
    sql = "insert into rtstocks(code, cashin, cashout, netvalue, iorate, turnover, price, changeratio, amountp, acountn, mtime)  values('%s', %0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %s )" \
            %(stockdata['code'], stockdata['cashin'], stockdata['cashout'], stockdata['netvalue'], stockdata['iorate'], stockdata['turnover'], stockdata['price'], stockdata['changeratio'], stockdata['amountp'],stockdata['amountn'], mytime) 
...
def UpdateRTData( stockdata, logger, mytime ):
    ...
    sql = "update rtstocks set cashin=%0.2f, cashout=%0.2f, netvalue=%0.2f, iorate=%0.2f, turnover=%0.2f, price=%0.2f, changeratio=%0.2f, amountp=%0.2f, acountn=%0.2f, mtime=%s where code='%s'" \
